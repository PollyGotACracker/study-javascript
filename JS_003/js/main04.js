 ...
 * querySelectorAll() 을 사용하여 tag 들이나 class 로 설정된 항목을
...
// const로 선언했을지라도 Array가 참조 자료형이기 때문에 배열 요소는 변경 가능
strs[0] = "우리나라만세";
...
document.write(strs[0]);
document.write("<br />");
document.write(strs[4]); // undefined를 출력
document.write("<br />");
...
strs[4] = "KOREA"; // 값이 저장되어 배열의 개수가 5로 증가(strs[3]은 undefined). JS에서만 가능
document.write(strs[4]);
document.write("<br />");
document.write(strs[3]); // undefined를 출력
document.write("<br />");
